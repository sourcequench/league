...
svg.append("text").attr("x", 320).attr("y", 30).text("KevinH").style("font-size", "15px").attr("alignment-baseline","middle")
svg.append("text").attr("x", 320).attr("y", 60).text("BryanH").style("font-size", "15px").attr("alignment-baseline","middle")
